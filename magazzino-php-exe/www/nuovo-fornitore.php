...
?>
<head>
    <title>Registra nuovo fornitore</title>
...
<div class="container" style="background-color: #f2f2f5;border-radius: 16px;padding: 2%;margin-top: 3%;">
    ...
    <form method="post" action="controllo-seriale-fornitore.php">
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon3">Nominativo Fornitore</span>
            </div>
        ...
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon3">Seriale Fornitore</span>
            </div>
            <input type="text" placeholder="Inserire la stringa che permette di generare il qr code" class="form-control" name="id" id="id"
                   aria-describedby="basic-addon3" required>
        </div>
        <div>
            <input type="submit" class="btn btn-success" value="Inserisci Fornitore">
        </div>
    </form>
</div>
</body>
